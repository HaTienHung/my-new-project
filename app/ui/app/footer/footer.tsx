...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-100 shadow-lg border-t border-gray-300 text-primary">
          ...
          <div className="w-full md:w-1/3 px-4">
            ...
            <div className="space-y-3 text-base">
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:hungtmt1102@gmail.com" className="text-primary hover:underline">
              ...
              <p className="text-sm text-primary">Chúng tôi sẽ phản hồi email trong vòng 24h.</p>
            </div>
          </div>
        </div>
      </div>
