...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-blue-500 text-white text-sm border-b border-gray-300 border-solid shadow sticky top-0 z-50">
        {/* Top bar */}
          ...
          <div className="container mx-auto items-center justify-between px-4">
            <div className="flex">
              ...
              <div className="flex items-center space-x-1 cursor-pointer" onClick={() => setShowMenu(!showMenu)}>
                ...
                <span className=" text-base font-medium tracking-wide select-none">DANH MỤC SẢN PHẨM</span>
